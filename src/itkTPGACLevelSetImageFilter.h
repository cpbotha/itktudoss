...
public:
  ...
  /** had to manually bring these over from
      itkSparseFieldLevelSetIMageFilter for this to build on g++ 4.0 */
...
protected:
  ...
  /** Overridden from the parent class
      (itkSparseFieldLevelSetImageFilter) to indroduce a constraint on
